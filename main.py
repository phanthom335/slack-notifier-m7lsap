        """
        Slack Notifier M7lsap
        =====================
        GitHub Actions-compatible script to sync repository housekeeping tasks.
        ...
        APP_NAME    = "Slack Notifier M7lsap"
        APP_VERSION = "1.0.0"
...
def _step_report(config, report):   pass  # TODO
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="GitHub Actions-compatible script to sync repository housekeeping tasks.")
